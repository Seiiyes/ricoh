      ...
      <div className="container-padding container-padding-y max-w-7xl mx-auto">
        <div className="flex items-center justify-between mb-responsive">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-responsive-xl font-bold text-slate-900 tracking-tight">Mis Empresas</h1>
              <p className="text-slate-500 text-responsive-sm mt-0.5">Administrar empresas del sistema</p>
            </div>
          </div>
          <button
        ...
        <div className="bg-white rounded-2xl shadow-xl shadow-slate-200/40 border border-slate-100 overflow-hidden">
          <div className="card-padding-sm border-b border-slate-100 bg-slate-50/50">
