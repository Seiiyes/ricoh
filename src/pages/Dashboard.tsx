  ...
  return (
    <div className="flex h-screen bg-[#FDFDFD] font-sans overflow-hidden">
      ...
      <nav className="w-64 lg:w-72 bg-slate-900 border-r border-slate-800 text-white shadow-[10px_0_40px_rgba(0,0,0,0.08)] flex flex-col z-20 relative overflow-hidden">
        ...
        <div className="relative z-10 px-5 lg:px-6 py-5 lg:py-6">
        ...
        <div className="relative z-10 flex-1 py-2 lg:py-3 px-3 lg:px-4 space-y-1 lg:space-y-1.5 overflow-y-auto custom-scrollbar">
          ...
          <div className="px-3 lg:px-4 pb-1.5 lg:pb-2 pt-2.5 lg:pt-3">
...
const NavButton = ({ to, icon, label }: { to: string; icon: React.ReactNode; label: string }) => {
  ...
  return (
    <button
      onClick={() => navigate(to)}
      className={`w-full flex items-center gap-3 lg:gap-4 px-4 lg:px-5 py-2.5 lg:py-3 text-[10px] lg:text-[11px] font-black uppercase tracking-widest rounded-xl lg:rounded-2xl transition-all duration-500 group relative overflow-hidden ${
        isActive
