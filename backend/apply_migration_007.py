#!/usr/bin/env python3
"""
Script para aplicar migración 007: Snapshot de cierres y correcciones de BD
"""
import sys
import os
...
def apply_migration_007():
    """Aplica la migración 007"""
    
    print("=" * 80)
    print("🔧 APLICANDO MIGRACIÓN 007")
    print("=" * 80)
    print()
    ...
    if result != 0:
        ...
        print(f"   Asegúrese de tener un backup manual antes de continuar")
        respuesta = input("¿Desea continuar sin backup? (s/n): ")
        if respuesta.lower() != 's':
            print("❌ Migración cancelada")
            return False
    else:
